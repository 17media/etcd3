...
class Namespace {
    constructor(prefix, pool) {
        ...
        this.watchManager = new watch_1.WatchManager(this.watchClient);
    }
    /**
     ...
     */
    namespace(prefix) {
        return new Namespace(Buffer.concat([this.prefix, util_1.toBuffer(prefix)]), this.pool);
    }
}
