...
export interface ICallable {
    exec(service: keyof typeof Services, method: string, params: object, options?: grpc.CallOptions): Promise<any>;
...
export declare class ClusterClient {
     ...
     */
    memberList(options?: grpc.CallOptions): Promise<IMemberListResponse>;
}
