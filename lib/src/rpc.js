...
class WatchClient {
    ...
    watch(options) {
        return this.client
            .getConnection('Watch')
            .then(({ client, metadata }) => client.watch(metadata, options));
    }
}
...
class LeaseClient {
    ...
    leaseKeepAlive(options) {
        return this.client
            .getConnection('Lease')
            .then(({ client, metadata }) => client.leaseKeepAlive(metadata, options));
    }
    /**
...
class MaintenanceClient {
    ...
    snapshot(options) {
        return this.client
            ...
            .then(({ client, metadata }) => client.snapshot(metadata, options, {}));
    }
    /**
