...
describe('election', () => {
    ...
    beforeEach(() => __awaiter(this, void 0, void 0, function* () {
        ...
        election = new src_1.Election(client, 'test-election');
        yield election.ready();
    ...
    describe('campaign', () => {
        it('should wait for elected in campaign', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const election2 = new src_1.Election(client2, 'test-election');
            yield election2.ready();
            chai_1.expect(election.isCampaigning).to.be.true;
            chai_1.expect(election2.isCampaigning).to.be.false;
            const waitElection2 = election2.campaign('election2').then(() => {
                chai_1.expect(election.isCampaigning).to.be.false;
                chai_1.expect(election2.isCampaigning).to.be.true;
            });
            yield sleep(10);
            yield election.resign();
            yield waitElection2;
            yield util_1.tearDownTestClient(client2);
        }));
